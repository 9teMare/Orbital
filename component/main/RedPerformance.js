...
export default function BluePerformance({ route, navigation}) {
    ...
    const double = redTeam[index]["stats"]["doubleKills"]
    const triple = redTeam[index]["stats"]["tripleKills"]
    const quadra = redTeam[index]["stats"]["quadraKills"]
    const penta = redTeam[index]["stats"]["quadraKills"]
    const killingSpree = redTeam[index]["stats"]["killingSprees"]
        ...
        return (
            <View style={{alignItems: 'center', marginBottom: 10}}>
                <Text style={{fontSize: 18}}>
                    KDA: {redTeam[index]["stats"]["kills"]}/{redTeam[index]["stats"]["deaths"]}/{redTeam[index]["stats"]["assists"]}
                </Text>
            </View>
        )
    }
                ...
                <CollapsibleView title={<Text style={{color: 'black', fontSize: 18, marginTop: 8, marginBottom: 8}}>Damage</Text>} style={{backgroundColor: 'white', width: width, marginLeft: 0, borderColor: 'white', elevation: 1}}>
                    <View>
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["totalDamageDealt"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["magicDamageDealt"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["physicalDamageDealt"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["trueDamageDealt"]}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View>
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["totalDamageDealtToChampions"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["magicDamageDealtToChampions"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["physicalDamageDealtToChampions"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["trueDamageDealtToChampions"]}
                            </Text>
                        </View>
                    </View>
                </CollapsibleView>        
                ...
                <CollapsibleView title={<Text style={{color: 'black', fontSize: 18, marginTop: 8, marginBottom: 8}}>Damage Taken</Text>} style={{backgroundColor: 'white', width: width, marginLeft: 0, marginTop: 0, borderColor: 'white', elevation: 1}}>
                    <View>
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["totalDamageTaken"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["magicalDamageTaken"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["physicalDamageTaken"]}
                            </Text>
                        </View>
                        ...
                        <View style={styles.lineView}>
                            ...
                            <Text style={styles.lineTextRight}>
                                {redTeam[index]["stats"]["trueDamageTaken"]}
                            </Text>
                        </View>
                    </View>
                </CollapsibleView>        
        ...
        <ScrollView>
            <View style={styles.iconAndName}>
                ...
                <Text style={styles.summonerName}>
                    {participantIdentities[index+5]["player"]["summonerName"]}
                </Text>
                <View style={{marginBottom: 10, justifyContent: 'space-evenly', flexDirection: 'row'}}>
                    <Text style={{fontSize: 18, marginRight: 10}}>
                        Level: {redTeam[index]["stats"]["champLevel"]}
                    </Text>
                    <Text style={{fontSize: 18, marginRight: 10}}>
                        CS: {redTeam[index]["stats"]["totalMinionsKilled"]}
                    </Text>
                    <Text style={{fontSize: 18}}>
                        Gold Earned: {redTeam[index]["stats"]["goldEarned"]}
                    </Text>
                </View>
                {kda()}
            </View>
